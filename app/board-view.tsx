          ...
          <div className="flex min-w-0 flex-1 items-center gap-2">
            {isEditingTitle ? (
              ...
              <button
                ...
                className="text-foreground hover:bg-muted/80 group -mx-1 flex items-center gap-1.5 rounded px-1 py-0.5 text-left font-medium transition-colors disabled:cursor-default disabled:opacity-100 disabled:hover:bg-transparent"
              >
